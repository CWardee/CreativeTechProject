...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Instantiate(FoodToSpawn, new Vector3(Random.Range(-SpawnRadius, SpawnRadius), Random.Range(-SpawnRadius, SpawnRadius), Random.Range(-SpawnRadius, SpawnRadius)), Quaternion.identity);
        }
